export type MangoV4 = {
  ...
  instructions: [
      ...
      accounts: [
        {
          ...
          isMut: false;
          isSigner: false;
          relations: ['insurance_vault', 'admin'];
        },
        {
          name: 'admin';
          isMut: false;
      ...
      accounts: [
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['admin', 'insurance_vault'];
        },
        {
          name: 'admin';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: true;
          docs: ['group admin or fast listing admin, checked at #1'];
        },
        {
          name: 'serumProgram';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          relations: ['group', 'serum_program', 'serum_market_external'];
        },
        {
          name: 'serumProgram';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ['needed for the automatic settle_funds call'];
        },
        {
          name: 'payerBank';
          isMut: true;
          isSigner: false;
          docs: ['The bank that pays for the order, if necessary'];
          relations: ['group'];
        },
        {
          name: 'payerVault';
          isMut: true;
          isSigner: false;
          docs: ['The bank vault that pays for the order, if necessary'];
        },
        {
          name: 'payerOracle';
          isMut: false;
    ...
    },
    {
      ...
      docs: ['requires the receiver_bank in the health account list to be writable'];
      accounts: [
        {
          name: 'group';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['group', 'bids', 'asks', 'event_queue'];
        },
        {
          name: 'bids';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['group', 'bids', 'asks', 'event_queue', 'oracle'];
        },
        {
          name: 'bids';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['group', 'bids', 'asks', 'oracle'];
        },
        {
          name: 'bids';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ["The bank's token_index is checked at #1"];
          relations: ['group'];
        },
        {
          name: 'sellBank';
    ...
    },
    {
      ...
      docs: ['Warning, this instruction is for testing purposes only!'];
      accounts: [
        {
          name: 'group';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          relations: ['group', 'openbook_v2_program', 'openbook_v2_market_external'];
        },
        {
          name: 'openbookV2Program';
          isMut: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ["can't zerocopy this unfortunately"];
        },
        {
          name: 'openOrdersAccount';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          relations: ['group', 'openbook_v2_market_external', 'openbook_v2_program'];
        },
        {
          name: 'openbookV2Program';
          isMut: false;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['bids', 'asks', 'event_heap'];
        },
        {
          name: 'bids';
          isMut: true;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['The bank vault that pays for the order'];
        },
        {
          name: 'receiverBank';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['market_base_vault', 'market_quote_vault'];
        },
        {
          name: 'marketBaseVault';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          relations: ['bids', 'asks', 'event_heap', 'market_base_vault', 'market_quote_vault'];
        },
        {
          name: 'bids';
          isMut: true;
  ...
  accounts: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'netBorrowLimitWindowSizeTs';
            docs: ['Size in seconds of a net borrows window'];
            type: 'u64';
          },
          {
            name: 'lastNetBorrowsWindowStartTs';
            docs: ['Timestamp at which the last net borrows window started'];
            type: 'u64';
          },
          {
            name: 'netBorrowLimitPerWindowQuote';
            docs: ['Net borrow limit per window in quote native; set to -1 to disable.'];
            type: 'i64';
          },
          {
            name: 'netBorrowsInWindow';
            docs: ['Sum of all deposits and borrows in the last window, in native units.'];
            type: 'i64';
          },
          {
            name: 'borrowWeightScaleStartQuote';
          ...
          {
            name: 'tokenConditionalSwapTakerFeeRate';
            docs: ['Fees for the token conditional swap feature'];
            type: 'f32';
          },
          {
            name: 'tokenConditionalSwapMakerFeeRate';
          ...
          },
          {
            ...
            docs: ['Maint asset weight to reach at _shift_end.'];
            type: {
              defined: 'I80F48';
            };
          },
          ...
          {
            name: 'depositLimit';
            docs: ['zero means none, in token native'];
            type: 'u64';
          },
          {
            name: 'zeroUtilRate';
          ...
          {
            name: 'collateralFeePerDay';
            docs: ['The daily collateral fees rate for fully utilized collateral.'];
            type: 'f32';
          },
          {
            name: 'padding2';
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ['Number of fast listings that happened this interval'];
            type: 'u16';
          },
          {
            name: 'allowedFastListingsPerInterval';
            docs: ['Number of fast listings that are allowed per interval'];
            type: 'u16';
          },
          {
            name: 'padding2';
          ...
          },
          {
            ...
            docs: ['Intervals in which collateral fee is applied'];
            type: 'u64';
          },
          {
            name: 'reserved';
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ['Init health as calculated during HealthReginBegin, rounded up.'];
            type: 'i64';
          },
          {
            name: 'frozenUntil';
          ...
          },
          {
            ...
            docs: ['End timestamp of the current expiry interval of the buyback fees amount.'];
            type: 'u64';
          },
          {
            name: 'nextTokenConditionalSwapId';
            docs: ['Next id to use when adding a token condition swap'];
            type: 'u64';
          },
          {
          ...
          },
          {
            ...
            docs: ['Time at which the last collateral fee was charged'];
            type: 'u64';
          },
          {
            name: 'reserved';
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'blocked1';
            docs: ['Field used to contain the trusted_market flag and is now unused.'];
            type: 'u8';
          },
          {
            name: 'groupInsuranceFund';
            docs: ['Is this market covered by the group insurance fund?'];
            type: 'u8';
          },
          {
            name: 'bump';
          ...
          {
            name: 'stablePriceModel';
            docs: ['Maintains a stable price based on the oracle price that is less volatile.'];
            type: {
              defined: 'StablePriceModel';
            };
          },
          ...
          {
            name: 'minFunding';
            docs: ['Minimal funding rate per day, must be <= 0.'];
            type: {
              defined: 'I80F48';
            };
          },
          {
            name: 'maxFunding';
            docs: ['Maximal funding rate per day, must be >= 0.'];
            type: {
              defined: 'I80F48';
            };
          },
          {
            name: 'impactQuantity';
            docs: ['For funding, get the impact price this many base lots deep into the book.'];
            type: 'i64';
          },
          {
            name: 'longFunding';
          ...
          },
          {
            ...
            docs: ['timestamp that funding was last updated in'];
            type: 'u64';
          },
          {
            name: 'baseLiquidationFee';
            docs: ['Fees', 'Fee for base position liquidation'];
            type: {
              defined: 'I80F48';
            };
          },
          {
            name: 'makerFee';
            docs: ['Fee when matching maker orders. May be negative.'];
            type: {
              defined: 'I80F48';
            };
          },
          ...
          {
            name: 'settleFeeAmountThreshold';
            docs: ['Pnl settlement amount needed to be eligible for the flat fee.'];
            type: 'f32';
          },
          {
            name: 'settleFeeFractionLowHealth';
          ...
          {
            name: 'settlePnlLimitWindowSizeTs';
            docs: ['Window size in seconds for the perp settlement limit'];
            type: 'u64';
          },
          {
            name: 'reduceOnly';
          ...
          {
            name: 'maintOverallAssetWeight';
            docs: ['Weights for full perp market health, if positive'];
            type: {
              defined: 'I80F48';
            };
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'loan';
            docs: ["The amount that was a loan (<= approved_amount, depends on user's deposits)"];
            type: 'i128';
          },
          {
            name: 'loanOriginationFee';
            docs: ['The fee paid on the loan, not included in `loan` or `change_amount`'];
            type: 'i128';
          },
          {
            name: 'depositIndex';
          ...
          {
            name: 'approvedAmount';
            docs: ['The amount that was transfered out to the user'];
            type: 'u64';
          },
        ];
      };
        ...
        fields: [
          {
            ...
            docs: ['The deposit_index (if positive) or borrow_index (if negative) scaled position'];
            type: {
              defined: 'I80F48';
            };
          },
          {
            name: 'tokenIndex';
            docs: ['index into Group.tokens'];
            type: 'u16';
          },
          {
            name: 'inUseCount';
            docs: ['incremented when a market requires this position to stay alive'];
            type: 'u16';
          },
          {
            name: 'padding';
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ['Index of the current settle pnl limit window'];
            type: 'u32';
          },
          {
          ...
          },
          {
            ...
            docs: ['Active position size, measured in base lots'];
            type: 'i64';
          },
          {
          ...
          },
          {
            ...
            docs: ['Tracks what the position is to calculate average entry & break even price'];
            type: 'i64';
          },
          {
            name: 'longSettledFunding';
            docs: ['Already settled long funding'];
            type: {
              defined: 'I80F48';
            };
          },
          {
            ...
            docs: ['Already settled short funding'];
            type: {
              defined: 'I80F48';
            };
          },
          ...
          {
            name: 'takerBaseLots';
            docs: ['Amount of base lots on the EventQueue waiting to be processed'];
            type: 'i64';
          },
          {
            name: 'takerQuoteLots';
            docs: ['Amount of quote lots on the EventQueue waiting to be processed'];
            type: 'i64';
          },
          {
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ['Maximal relative difference between two delay_price in consecutive intervals.'];
            type: 'f32';
          },
          {
          ...
          },
          {
            ...
            docs: ['The delay_interval_index that update() was last called on.'];
            type: 'u8';
          },
          {
            name: 'resetOnNonzeroPrice';
            docs: ['If set to 1, the stable price will reset on the next non-zero price it sees.'];
            type: 'u8';
          },
          {
            name: 'padding';
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'maxBuy';
            docs: ['maximum amount of native tokens to buy or sell'];
            type: 'u64';
          },
          {
            name: 'maxSell';
          ...
          {
            name: 'bought';
            docs: ['how many native tokens were already bought/sold'];
            type: 'u64';
          },
          {
            name: 'sold';
          ...
          {
            name: 'expiryTimestamp';
            docs: ['timestamp until which the conditional swap is valid'];
            type: 'u64';
          },
          {
            name: 'priceLowerLimit';
          ...
          {
            name: 'priceUpperLimit';
            docs: ['Parallel to price_lower_limit, but an upper limit / auction end price.'];
            type: 'f64';
          },
          {
            name: 'pricePremiumRate';
            docs: ['The premium to pay over oracle price to incentivize execution.'];
            type: 'f64';
          },
          {
            name: 'takerFeeRate';
            docs: ['The taker receives only premium_price * (1 - taker_fee_rate)'];
            type: 'f32';
          },
          {
            name: 'makerFeeRate';
            docs: ['The maker has to pay premium_price * (1 + maker_fee_rate)'];
            type: 'f32';
          },
          {
            name: 'buyTokenIndex';
            docs: ['indexes of tokens for the swap'];
            type: 'u16';
          },
          {
            name: 'sellTokenIndex';
          ...
          {
            name: 'isConfigured';
            docs: ['If this struct is in use. (tcs are stored in a static-length array)'];
            type: 'u8';
          },
          {
            name: 'allowCreatingDeposits';
          ...
          {
            name: 'tcsType';
            docs: ['Stores a TokenConditionalSwapType enum value'];
            type: 'u8';
          },
          {
            name: 'padding';
